...
class Client:
    ...
    def get_movies(self, **kwargs):
        ...
        Example:
           ...
           movies = client.get_movies(sort='name:asc', runtimeInMinutes=('>=', 90))
        """
    ...
    def get_movie(self, movie_id):
        ...
        Example:
           movie = client.get_movie('5cd95395de30eff6ebccde5d')
        """
    ...
    def get_movie_quotes(self, movie_id):
        ...
        Example:
           movie_quotes = client.get_movie_quotes('5cd95395de30eff6ebccde5d')
        """
    ...
    def get_quotes(self, **kwargs):
        ...
        Example:
           ...
           quotes = client.get_quotes(character='Gandalf', limit=5, sort='dialog:asc')
        """
    ...
    def get_quote(self, quote_id):
        ...
        Example:
           quote = client.get_quote('5cd96e05de30eff6ebccebd0')
        """
